                                ...
                                <div className="flex flex-col items-end space-y-4">
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-400 border border-indigo-500/20 text-sm font-medium rounded-lg transition-colors"
                                        >
                                            Download Ticket
                                        </button>
