...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<BookingResponse> createBooking(@AuthenticationPrincipal CustomUserDetails currentUser, @RequestBody BookingDto bookingDto){
    ...
    public ResponseEntity<BookingResponse> cancelBooking(@AuthenticationPrincipal CustomUserDetails currentUser, @PathVariable Long id){
        return ResponseEntity.ok(new BookingResponse(bookingService.cancelBooking(currentUser, id)));
    }

    @PutMapping("{id}/reject")
    public ResponseEntity<BookingResponse> rejectBooking(@AuthenticationPrincipal CustomUserDetails currentUser, @PathVariable Long id){
        return ResponseEntity.ok(new BookingResponse(bookingService.rejectBooking(currentUser, id)));
    }

    @PutMapping("{id}/approve")
    public ResponseEntity<BookingResponse> approveBooking(@AuthenticationPrincipal CustomUserDetails currentUser, @PathVariable Long id){
